...
const TRI_COLS: [gles30::GLfloat; 12] = [
...
fn render(gl: &GlFns, program: gles30::GLuint, x: i32, y: i32) {
    unsafe {
        ...
        let pos_handle: gles30::GLuint = gl
            .GetAttribLocation(program, CString::new("VertexPosition").unwrap().as_ptr())
            as gles30::GLuint;
